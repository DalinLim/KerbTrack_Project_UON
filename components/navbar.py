...
navbar = html.Nav(className="bg-emerald-700", children=[
    html.Div(className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children=[
        html.Div(className="flex justify-between h-16", children=[
            ...
            html.Div(className="hidden md:flex space-x-4 mt-2", children=[
                dcc.Link(
                    "Dashboard", href="/",
            ...
            html.Div(className="md:hidden flex items-center", children=[
                html.Button(
                    "☰",
                    id="menu-toggle",
                    n_clicks=0,
    ...
    html.Div(id="mobile-menu", className="md:hidden hidden px-2 pt-2 pb-3 space-y-1", children=[
        dcc.Link(
            "Dashboard", href="/",
